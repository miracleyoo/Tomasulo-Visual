...
public enum ConfigKey {
    ...
    FU_FPADDER_CYCLES("FU_FPADDER_CYCLES"),
    FU_FPDIVIDER_CYCLES("FU_FPDIVIDER_CYCLES"),
    FU_FPMULT_CYCLES("FU_FPMULT_CYCLES"),
    FU_MEM_CYCLES("FU_MEM_CYCLES"),
    FU_INT_CYCLES("FU_MEM_CYCLES"),

    INT_ADDERS("INT_ADDERS"),
    FP_ADDERS("FP_ADDERS"),
    FP_MULTIPLIERS("FP_MULTIPLIERS"),
    FP_DIVIDERS("FP_DIVIDERS");
